		        ...
		        <div class="card">
		        	<div class="thumbnail card">
		        		<div class="head">
		          		...
		          		<img class="card-img-top" src="./image/blogs/blog businessman.jpg">
		          		<div class="card-body">
			            	<h4 class="card-title">What we have done in last six weeks?</</h4>
			            	<p class="card-text">John is an Internet entrepreneur with almost 20year of experience.John is an Internet entrepreneur with almost 20year of experience.  </p>
		                </div>
		            </div>  
		        </div> 
		    </div>
	    ...
	    <div class="side-content">
	    	<div row>
	    		...
	    		<div class="col-md-9">
	    			<div class="text">
	    				<p>
	    			         Lorem ipsum dolor sit amet,eu quidam omnesque.
